...
from exnova.http.login import Login
from exnova.http.loginv2 import Loginv2
from exnova.http.logout import Logout
from exnova.http.login2fa import Login2FA
from exnova.http.send_sms import SMS_Sender
from exnova.http.verify import Verify
from exnova.http.getprofile import Getprofile
from exnova.http.auth import Auth
from exnova.http.token import Token
from exnova.http.appinit import Appinit
from exnova.http.billing import Billing
from exnova.http.buyback import Buyback
from exnova.http.changebalance import Changebalance
from exnova.http.events import Events
from exnova.ws.client import WebsocketClient
from exnova.ws.chanels.get_balances import *

from exnova.ws.chanels.ssid import Ssid
from exnova.ws.chanels.subscribe import *
from exnova.ws.chanels.unsubscribe import *
from exnova.ws.chanels.setactives import SetActives
from exnova.ws.chanels.candles import GetCandles
from exnova.ws.chanels.buyv2 import Buyv2
from exnova.ws.chanels.buyv3 import *
from exnova.ws.chanels.user import *
from exnova.ws.chanels.api_game_betinfo import Game_betinfo
from exnova.ws.chanels.instruments import Get_instruments
from exnova.ws.chanels.get_financial_information import GetFinancialInformation
from exnova.ws.chanels.strike_list import Strike_list
from exnova.ws.chanels.leaderboard import Leader_Board

from exnova.ws.chanels.traders_mood import Traders_mood_subscribe
from exnova.ws.chanels.traders_mood import Traders_mood_unsubscribe
from exnova.ws.chanels.technical_indicators import Technical_indicators
from exnova.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from exnova.ws.chanels.get_order import Get_order
from exnova.ws.chanels.get_deferred_orders import GetDeferredOrders
from exnova.ws.chanels.get_positions import *

from exnova.ws.chanels.get_available_leverages import Get_available_leverages
from exnova.ws.chanels.cancel_order import Cancel_order
from exnova.ws.chanels.close_position import Close_position
from exnova.ws.chanels.get_overnight_fee import Get_overnight_fee
from exnova.ws.chanels.heartbeat import Heartbeat


from exnova.ws.chanels.digital_option import *
from exnova.ws.chanels.api_game_getoptions import *
from exnova.ws.chanels.sell_option import Sell_Option
from exnova.ws.chanels.sell_digital_option import Sell_Digital_Option
from exnova.ws.chanels.change_tpsl import Change_Tpsl
from exnova.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from exnova.ws.objects.timesync import TimeSync
from exnova.ws.objects.profile import Profile
from exnova.ws.objects.candles import Candles
from exnova.ws.objects.listinfodata import ListInfoData
from exnova.ws.objects.betinfo import Game_betinfo_data
import exnova.global_value as global_value
...
class exnova(object):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, host, ws_host, username, password, proxies=None):
        """
        ...
        self.wss_url = "wss://{ws_host}/echo/websocket".format(ws_host=ws_host)
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <exnova.http.resource.Resource>`.
    ...
    def send_sms_code(self):
        ...
        :returns: The instance of :class:`SMS_Sender
            <exnova.http.send_sms.SMS_Sender>`.
        """
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <exnova.http.changebalance.Changebalance>`.
        """
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <exnova.http.getprofile.Getprofile>`.
        """
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <exnova.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <exnova.ws.chanels.unsubscribe.Unsubscribe>`.
        """
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <exnova.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <exnova.ws.chanels.candles.GetCandles>`.
        """
